...
meili_client = Client('http://ytdlmeili:7700', 'ZzTS8peCyJNC8nrZWu0aQU5td9DAajM1JVHh6dy96thArm917rNIWy2QE1ziMBj1')  ################################################################
meili_api_key = 'ZzTS8peCyJNC8nrZWu0aQU5td9DAajM1JVHh6dy96thArm917rNIWy2QE1ziMBj1'
# meili_index = meili_client.index('yt-dlp_index') ################################################################
# meili_url for reverse proxy
meiliproxy = "http://ytdlmeili:7700"
